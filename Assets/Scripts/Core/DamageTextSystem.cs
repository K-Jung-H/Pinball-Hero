...
public class DamageTextSystem : MonoBehaviour
{
    ...
    private readonly Queue<BallHitResult> pendingResults = new Queue<BallHitResult>(64);
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < spawnCount; i++)
        {
            ...
            BallHitResult result = pendingResults.Dequeue();
    ...
    private void Enqueue(BallHitResult result)
    {
        if (result.Damage <= 0)
        {
            return;
    ...
    private static DamageFeedbackType ResolveFeedbackType(BallHitResult result)
    {
